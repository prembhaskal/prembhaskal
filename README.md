...
- Below is list of my current and past projects:
  -  [VMware](https://www.vmware.com), 2023-Current, SMTS in [Carvel](https://carvel.dev/) project, working on new Tanzu Application Platform (TAP) using multi-tenancy https://github.com/kcp-dev/kcp. Here I mainly work on Kubernetes writing custom controllers and maintaining Carvel tools. 
